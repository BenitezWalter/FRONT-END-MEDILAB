...
const UserProfile = () => {
    return (
        <>
            ...
            <br />
            <br />
            <div class="container rounded bg-white mt-5 mb-5 " id="userProfile">
                <div class="row">
                    ...
                    <div class="col-md-5 border-right">
                        <div class="p-3 py-5">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12"><label class="labels">Email ID</label><input type="text" class="form-control" placeholder="enter email id" value="" readOnly/></div>
